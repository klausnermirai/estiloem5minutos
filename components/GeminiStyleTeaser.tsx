      ...
      <div className="max-w-4xl mx-auto px-4 text-center">
        <div className="inline-flex items-center justify-center p-3 bg-white/10 rounded-full mb-6 backdrop-blur-sm">
          ...
          <span className="font-semibold tracking-wider uppercase text-sm">
            <EditableText id="gemini_badge" defaultText="IA Style Booster" />
          </span>
        </div>
        
        <h2 className="text-3xl font-serif font-bold mb-4">
          <EditableText id="gemini_title" defaultText="Experimente o Poder da Intenção" />
        </h2>
        <div className="text-brand-100 mb-8 max-w-2xl mx-auto">
          <EditableText 
            id="gemini_desc" 
            defaultText="No curso, ensinamos como alinhar sua mente com seu estilo. Escolha como você quer se sentir hoje e receba uma <strong>dica exclusiva e um mantra</strong> gerado pela nossa Inteligência Artificial para te inspirar agora. (Requer API Key)"
            tag="p"
            multiline={true}
          />
        </div>
        ...
        {!result ? (
          <div className="bg-white/10 p-8 rounded-2xl backdrop-blur-md border border-white/20">
            <p className="mb-6 text-lg font-medium">
              <EditableText id="gemini_prompt_q" defaultText="Como você deseja se sentir hoje?" />
            </p>
            ...
            >
              {loading ? (
                ...
                <EditableText id="gemini_btn_text" defaultText="Receber Meu Mantra & Dica" />
              )}
            </button>
          </div>
        ) : (
          <div className="bg-white text-gray-900 p-8 rounded-2xl shadow-2xl animate-fade-in relative overflow-hidden">
             ...
             <div className="relative z-10">
                <h3 className="text-brand-600 font-bold uppercase tracking-widest text-sm mb-2">
                  <EditableText id="gemini_result_label" defaultText="Seu Mantra do Dia" />
                </h3>
                ...
                <div className="bg-brand-50 p-6 rounded-xl border-l-4 border-brand-500 text-left">
                  <h4 className="font-bold text-brand-800 flex items-center mb-2">
                    ...
                    <EditableText id="gemini_tip_label" defaultText="Dica de Estilo Rápida:" />
                  </h4>
                ...
                <div className="mt-8 pt-6 border-t border-gray-100">
                  <p className="text-sm text-gray-500 mb-4">
                    <EditableText id="gemini_upsell" defaultText="Gostou? Isso é só 1% do que você vai aprender no curso." />
                  </p>
                  <button 
                    onClick={() => { setResult(null); setSelectedTone(null); }}
                    className="text-brand-600 font-medium hover:text-brand-800 underline"
                  >
                    <EditableText id="gemini_retry" defaultText="Tentar outra vibração" />
                  </button>
                </div>
             </div>
          </div>
