...
export default function App() {
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900">
      ...
      <div className="fixed top-0 inset-x-0 z-50 bg-brand-900 text-white text-center py-2.5 text-xs sm:text-sm font-medium shadow-md">
        <span className="animate-pulse mr-2">🔥</span> 
        Oferta especial: Curso completo de R$ 97,00 por <span className="font-bold text-gold-400">apenas R$ 37,00</span> hoje!
      </div>
          ...
          <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="bg-white p-8 rounded-2xl shadow-lg text-left transform hover:-translate-y-1 transition-transform duration-300">
                ...
                <p className="text-gray-600 mb-6 text-lg italic">"Eu gastava 40 minutos pra escolher uma roupa e saía insatisfeita. Hoje demoro 5 e me sinto linda. O módulo de meditação mudou minha ansiedade matinal. Vale cada centavo!"</p>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg text-left transform hover:-translate-y-1 transition-transform duration-300">
                <div className="flex text-gold-500 mb-4">★★★★★</div>
                <p className="text-gray-600 mb-6 text-lg italic">"Por 37 reais eu não esperava tanto conteúdo. A técnica de planejamento salvou minhas manhãs com as crianças. Me sinto uma nova mulher."</p>
                <div className="flex items-center">
